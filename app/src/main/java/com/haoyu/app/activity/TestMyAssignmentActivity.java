...
public class TestMyAssignmentActivity extends BaseActivity  {
    ...
    public int setLayoutResID() {
        return R.layout.activity_detailscore_assignment;
    }
    ...
    public void initView() {
        ...
        mMarkScore = (TextView) findViewById(R.id.markScore);
        commitWarn = (TextView) findViewById(R.id.commit_warn);
        mResponseScore = (TextView) findViewById(R.id.test_responoseScore);
    }
